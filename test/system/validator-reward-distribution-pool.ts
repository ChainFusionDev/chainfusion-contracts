...
describe('ValidatorRewardDistributionPool', function () {
  it('should collect rewards', async function () {
    ...
    const reward = totalReward.div(BigNumber.from('2'));
    ...
    const txFee1 = validator3BalanceBefore.add(reward).sub(validator3BalanceAfte);
    const txFee2 = validator2BalanceBefore.add(reward).sub(validator2BalanceAfte);
