...
//
// Solidity: function updateSigner(uint256 _generation, address _signerAddress) returns()
func (_DKG *DKGTransactor) UpdateSigner(opts *bind.TransactOpts, _generation *big.Int, _signerAddress common.Address) (*types.Transaction, error) {
	return _DKG.contract.Transact(opts, "updateSigner", _generation, _signerAddress)
}

// UpdateSigner is a paid mutator transaction binding the contract method 0x8f283a86.
//
// Solidity: function updateSigner(uint256 _generation, address _signerAddress) returns()
func (_DKG *DKGSession) UpdateSigner(_generation *big.Int, _signerAddress common.Address) (*types.Transaction, error) {
	return _DKG.Contract.UpdateSigner(&_DKG.TransactOpts, _generation, _signerAddress)
}

// UpdateSigner is a paid mutator transaction binding the contract method 0x8f283a86.
//
// Solidity: function updateSigner(uint256 _generation, address _signerAddress) returns()
func (_DKG *DKGTransactorSession) UpdateSigner(_generation *big.Int, _signerAddress common.Address) (*types.Transaction, error) {
	return _DKG.Contract.UpdateSigner(&_DKG.TransactOpts, _generation, _signerAddress)
}
